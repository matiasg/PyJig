...
def test_jigsaw():
    ...
    expected = {
        ...
        <path d="M 5.0,2.0 C 5.0,2.0 7.5,1.7 7.0,2.0 C 6.5,2.3 8.5,2.3 8.0,2.0 C 7.5,1.7000000000000002 10.0,2.0 10.0,2.0 C 10.0,2.0 10.75,3.0 10.0,2.8 C 9.25,2.5999999999999996 9.25,3.4 10.0,3.2 C 10.75,3.0000000000000004 10.0,4.0 10.0,4.0 C 10.0,4.0 7.5,4.3 8.0,4.0 C 8.5,3.7 6.5,3.7 7.0,4.0 C 7.5,4.3 5.0,4.0 5.0,4.0 C 5.0,4.0 4.25,3.0 5.0,3.2 C 5.75,3.4000000000000004 5.75,2.6 5.0,2.8 C 4.25,2.9999999999999996 5.0,2.0 5.0,2.0" stroke="black" fill="white"/>
        </svg>""",
